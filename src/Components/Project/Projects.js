...
function Projects() {
    ...
    const stateList = [
        ...
        },
        {
            ...
            workDone: {
                work1: 'Developed front end prototype capable of processing json data' +
                    ' converting it to essential data for processing and presentation.',
                work2: 'Integrated materials-ui to front end improving site aesthetics',
        ...
        },
        {
            ...
            workDone: {
                work1: "Implemented text to speech and speech to text android API's",
        ...
        },
        {
            ...
            workDone: {
                work1: 'Created parser capable of parsing large amounts of unequally lengthed text files to csv',
                work2: '',
            },
            type: 0,
            progUsage: {
